...
const PostModel = (props) => {
    ...
    const [assestArea, setAssetArea ] = useState("");
        ...
        <Container>
            <Content>
                ...
                <Editor>
                   ...
                   <UploadImage>
                        <input type="file" 
                        except="image/gif, image/jpg, image/png" 
                        name="image" id="file"
                        style={{ display:"none" }}
                ...
                <ShareCreation>
                   <AttachAssest>
                       <AssestButton onClick={() => swtichAssestArea("image")}>
                           <img src="/images/share-image.png" alt="" />
                       </AssestButton>
                       <AssestButton onClick={() => swtichAssestArea("media")}>
